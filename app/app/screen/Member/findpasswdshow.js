...
const Findidshow = (props) => {
    ...
    async function func_login() {
        console.log("&act=member&han=chpasswd2&id="+id+"&newpasswd="+newpasswd)
        await Axios.get("&act=member&han=chpasswd2&id="+id+"&newpasswd="+newpasswd,
            (response) => {
        ...
        return (
            <Layout havebottom={false} havetop={true} havnoback={true} toptext={""} navigation={props.navigation}>
                ...
                <View style={[glSt.px24,glSt.pt54]}>
                    <View style={[glSt.mb32]}>
                        <View style={glSt.mb16}>
                            <Text style={[glSt.text18b,glSt.c322A24]}>비밀번호 재설정</Text>
                        </View>
                        <View style={glSt.mb16}>
                            <Text style={[glSt.text14m,glSt.c6F6963]}>비밀번호를 변경해 주세요.</Text>
                            <Text style={[glSt.text14m,glSt.c6F6963]}>영문, 숫자, 특수문자 포함 8~20자 이내로 입력해 주세요</Text>
                        </View>
                    </View>
                    <View style={[glSt.mb16]}>
                        <View style={glSt.mb8}>
                ...
                <View style={[glSt.px24]}>
                    <TouchableOpacity  onPress={() => check_login()} style={[(newpasswdOk && renewpasswdOk) ? glSt.bg322A24 : glSt.bgDBD7D0,glSt.h46,glSt.alcenter,glSt.jucenter,glSt.mb24]}>
                        <Text style={[glSt.text14b,glSt.cFFFFFF]}>비밀번호 재설정</Text>
                    </TouchableOpacity>
                </View>
