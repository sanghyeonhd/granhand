        ...
        <Layout havebottom={false} havetop={true} havnoback={true} havebtn1={false} havebtn2={false} toptext={"선물함"} navigation={props.navigation}>
            <View style={[glSt.px24,glSt.pt10,glSt.flex]}>
                <TouchableOpacity onPress={() => setViewmode(1)} style={[glSt.mr20]}>
                    <Text style={[viewmode == 1 ? glSt.c6F6963 : glSt.cC0BCB6,glSt.text12b]}>받은 선물</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setViewmode(2)} style={[glSt.mr20]}>
                    <Text style={[viewmode == 2 ? glSt.c6F6963 : glSt.cC0BCB6,glSt.text12b]}>보낸 선물</Text>
                </TouchableOpacity>
            </View>
            <View style={[glSt.alcenter,glSt.jucenter,glSt.pt54]}>
                <Text style={[glSt.cC0BCB6,glSt.text14m]}>선물 내역이 없어요.</Text>
            </View>
        </Layout>
    );
};
