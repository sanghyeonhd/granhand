<?php
session_start();
header("Expires: Tue, 01 Jan 2000 00:00:00 GMT");       // 오래된 날짜로 설정
header("Last-Modified: " . gmdate("D, d M Y H:i:s") . " GMT"); // 현재 시간
header("Cache-Control: no-store, no-cache, must-revalidate, max-age=0");
header("Cache-Control: post-check=0, pre-check=0", false);     // IE용 (비표준)
header("Pragma: no-cache"); // HTTP/1.0용
...
<?php
    ...
    $result_return_url = $protocol.$host."/dream/mok_std_resultn.php";
