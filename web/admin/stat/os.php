...
<div class="row">
	<div class="col-md-12">
		<div class="panel">
			<div class="panel-header">
				<h3><i class="fa fa-table"></i> 운영체제</h3>
			</div>
			<div class="panel-content">
				 <?php
...
if ($row != 0 )
{
	while( $data = mysql_fetch_array($result, MYSQL_ASSOC)) {
		...
		if ($os_name == "") {
			$os_name = "알수없음(Unknown)";
		}
	          	
  	echo "<tr>";
  	echo "	<td class='first'>".$num."</td>";
  	echo "	<td style='background-color:#EEB4E9;'>".$os_name."</td>";
  	echo "	<td id='os_avg_".$num."'>NaN</td>";
  	echo "</tr>";
  	echo "<input id='os_cnt_".$num."' type='hidden' value='".$count."' />";
