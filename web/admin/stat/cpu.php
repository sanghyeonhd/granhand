...
<div class="row">
	<div class="col-md-12">
		<div class="panel">
			<div class="panel-header">
				<h3><i class="fa fa-table"></i> cpu</h3>
			</div>
			<div class="panel-content">
				 <?php
...
if ($row != 0 )
{
	while( $data = mysql_fetch_array($result, MYSQL_ASSOC)) {
		...
		if ($cpu_name == "") {
			$cpu_name = "알수없음(Unknown)";
		}
	          	
  	echo "<tr>";
  	echo "	<td class='first'>".$num."</td>";
  	echo "	<td style='background-color:#EEB4E9;'>".$cpu_name."</td>";
  	echo "	<td id='cpu_avg_".$num."'>NaN</td>";
  	echo "</tr>";
  	echo "<input id='cpu_cnt_".$num."' type='hidden' value='".$count."' />";
