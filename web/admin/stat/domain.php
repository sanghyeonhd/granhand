...
if ($row != 0 )
{
	while( $data = mysql_fetch_array($result, MYSQL_ASSOC)) {
  	...
  	echo "<tr>";
  	echo "	<td style='background-color:#FFFFFF;color:blue;cursor:hand;' onClick='domainDetails(".$num.");'>상세정보</td>";
  	echo "	<td style='background-color:#EEB4E9;'>".$num."</td>";
  	echo "	<td style='background-color:#FFFFFF;text-decoration:none;padding-left:15px;text-align:left;'><a href='http://".$rf_full."' target='_blank'>".$rf_full."</td>";
  	echo "	<td id='rf_cnt_".$num_count."' style='background-color:#FFFFFF;'>".number_format($count)."</td>";
  	echo "	<td id='rf_avg_".$num_count."' style='background-color:#FFFFFF;'>0.00%</td>";
  	echo "</tr>";
