<?php /* Template_ 2.2.7 2025/07/10 09:14:18 /home/grandhand/BUILDS/tpls/basicw/member/findpasswdresult.htm 000005739 */ ?>
...
function checkmember()	{
	...
	if(pwdVal != '')	{
		$.get('/exec/proajax.php?act=member&han=chpasswd&id=<?php echo $_REQUEST["id"]?>&passwd='+pwdVal, function(response) {
			if(response.res=='ok')	{
				alert('비밀번호가 변경되었습니다.');
