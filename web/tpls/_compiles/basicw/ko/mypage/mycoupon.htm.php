<?php /* Template_ 2.2.7 2025/07/10 09:40:57 /home/grandhand/BUILDS/tpls/basicw/mypage/mycoupon.htm 000004814 */ ?>
...
<div class="container mx-auto pt-8">
	<div class="w-full py-10 mx-auto text-[#6F6963]">
		<div class="flex justify-between">
			<h1 class="text-lg font-medium mb-8">보유 쿠폰</h1>
		</div>
	</div>
				...
				<div>
					...
					<ul class="mt-2 space-y-1 text-sm font-medium">
						<a href="/mypage/?act=mycoupon">
							<li class="px-6 py-2 text-[#C0BCB6] bg-[#322A2408] rounded">보유 쿠폰</li>
						</a>
