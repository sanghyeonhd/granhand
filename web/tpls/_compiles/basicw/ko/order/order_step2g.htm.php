<?php /* Template_ 2.2.7 2025/07/10 10:58:30 /home/grandhand/BUILDS/tpls/basicw/order/order_step2g.htm 000034096 */ 
	...
	<div class="grid md:grid-cols-[739px_357px] gap-8 mt-10">
		<div>
			<section class="space-y-2 mb-10">
				<h2 class="text-sm font-bold text-[#322A24]">선물 메세지</h2>
				<div class="space-y-2">
					<div class="relative mt-6">
						<button class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 text-primary-foreground hover:bg-primary/90 h-10 absolute top-1/2 -translate-y-1/2 left-0 z-10 bg-transparent rounded-full p-1 border-none">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-left !w-[24px] !h-[24px] text-[#5E5955]" aria-hidden="true"><path d="m15 18-6-6 6-6"></path></svg>
						</button>
						<div class="flex gap-4 overflow-x-scroll pb-2 scroll-smooth snap-x snap-mandatory hide-scrollbar mx-8 h-[200px]" style="padding-left: calc(50% - 171px); padding-right: calc(50% - 171px);">
							<div class="min-w-[342px] h-[180px] rounded Card 1 text-sm text-center flex-shrink-0 snap-center">
								<div class="relative w-[342px] h-[180px]">
									<img alt="Gift" loading="lazy" decoding="async" data-nimg="fill" sizes="100vw" src="/img/gift-card1.png" style="position: absolute; height: 100%; width: 100%; inset: 0px; object-fit: cover; color: transparent;"><div class="absolute inset-0 bg-opacity-30 flex p-7">
										<textarea class="flex min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 text-white border-none font-medium placeholder:text-white resize-none" maxlength="100" placeholder="메시지를 입력하세요."></textarea>
									</div>
									<div class="absolute bottom-3 right-3 bg-opacity-30 flex text-[#FDFBF5]">0/100</div>
								</div>
							</div>
							
						</div>
						<button class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 text-primary-foreground hover:bg-primary/90 h-10 absolute top-1/2 -translate-y-1/2 right-0 z-10 bg-transparent p-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right !w-[24px] !h-[24px] text-[#5E5955]" aria-hidden="true"><path d="m9 18 6-6-6-6"></path></svg></button>
					</div>
					<div class="flex justify-center text-[#6F6963] text-xs font-medium">1/1</div>
				</div>
			</section>
			<section class="space-y-2 mb-10">
				<h2 class="font-bold text-[#322A24] text-sm mb-4">선물 받는 분 정보</h2>
				<div role="radiogroup" aria-required="false" dir="ltr" class="grid gap-2" tabindex="0" style="outline: none;">
					<div class="flex items-center gap-8">
						<label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex items-start gap-3 cursor-pointer space-y-4">
							<button type="button" role="radio" aria-checked="true" data-state="checked" value="kakao_talk" class="aspect-square rounded-full border border-primary text-primary ring-offset-background focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 w-[14px] h-[14px]" tabindex="-1" data-radix-collection-item=""><span data-state="checked" class="flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle h-[4px] w-[4px] fill-current text-[#6F6963]" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle></svg></span></button>
							<span class="text-xs text-[#6F6963]">카카오톡으로 선물</span>
						</label>
						<label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex items-start gap-3 cursor-pointer space-y-4">
							<button type="button" role="radio" aria-checked="false" data-state="unchecked" value="sms" class="aspect-square rounded-full border border-primary text-primary ring-offset-background focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 w-[14px] h-[14px]" tabindex="-1" data-radix-collection-item=""></button>
							<span class="text-xs text-[#6F6963]">문자(SMS)로 선물</span>
						</label>
					</div>
				</div>
				<div class="space-y-2 text-[10px] text-[#6F6963] h-[68px]">
				...
				<div class="space-y-2 mt-7">
					<label class="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 font-medium text-sm text-[#322A24]" for="receiver">받는 분 연락처*
						<input class="flex bg-background text-[#322A24] ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm w-full border font-normal h-[46px] !border-[#C0BCB6] rounded px-4 py-3 text-sm placeholder:text-[#C0BCB6] placeholder:font-medium mt-3" id="receiver" placeholder="받는 분의 실명을 입력해 주세요." type="text" valch="yes" msg="받는분 연락처를 입력하세요">
					</label>
				</div>
			</section>
...
<?php if($TPL_goodslist_1){foreach($TPL_VAR["goodslist"] as $TPL_V1){?>
				<div class="border shadow-md rounded-md p-6 space-y-4">
					<div class="flex gap-4 items-start">
						...
						<div class="flex-1 space-y-3 text-xs">
							...
							<div class="space-y-1">
								...
								<div class="text-sm text-[#322A24] font-bold mt-1"><?php echo $TPL_V1["account"]?>원</div>
							</div>
						</div>
					</div>
					...
					<div class="space-y-1 text-xs text-[#6F6963]">
							...
							<div class="flex">
								<span class="text-[#C0BCB6] w-24">쇼핑백</span><span>추가 구매 (+500원)</span>
							</div>
					</div>
					<hr class="my-4 border-dashed">
					<div>
							<div class="flex justify-between items-center mb-2">
								...
								<button type="button" role="switch" aria-checked="false" data-state="unchecked" value="on" class="peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-transparent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-primary data-[state=unchecked]:bg-input bg-[#FDFBF5] border"><span data-state="unchecked" class="pointer-events-none block h-5 w-5 rounded-full shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0 border bg-white"></span>
								</button>
							</div>
							<div class="flex items-center gap-2 relative">
								<input class="flex w-full bg-background ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm h-[46px] flex-1 border !border-[#C0BCB6] rounded px-3 py-3 text-sm text-[#322A24] placeholder:text-[#C0BCB6]" placeholder="원하는 문구를 입력해 주세요." disabled="" type="text" value="">
							...
							<p class="text-[10px] text-[#6F6963] mt-2">
								<span class="leading-[18px]">10자 이하 영문 대문자, 숫자, 특수기호(. , ! % &amp; ? ❤️)만 가능합니다.</span><br>스탬핑 작업시 교환 및 환불이 불가능합니다.
							</p>
					</div>
				</div>
<?php }}?>
			...
			<section class="space-y-2 mb-10">
				...
				<button type="button" role="combobox" aria-controls="radix-«r2r»" aria-expanded="false" aria-autocomplete="none" dir="ltr" data-state="closed" data-placeholder="" class="flex items-center justify-between border-input bg-background ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&amp;&gt;span]:line-clamp-1 w-full border !border-[#C0BCB6] rounded px-4 py-2 h-[46px] text-[#6F6963] data-[placeholder]:text-[#C0BCB6] text-[10px] font-bold"><span style="pointer-events: none;">쿠폰을 적용하세요.</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down h-4 w-4 opacity-50" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg></button>
			</section>
			<section class="space-y-2 mb-10">
				...
				<div class="flex gap-2">
					<input class="flex w-full bg-background text-[#322A24] ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm flex-1 border rounded px-3 py-2 text-sm h-[46px] !border-[#C0BCB6] placeholder:text-[#C0BCB6]" placeholder="사용하실 포인트를 입력해 주세요." type="text">
				...
				<div class="bg-[#FDFBF5] shadow-sm border rounded px-4 py-3 text-xs flex justify-between font-bold items-center text-[#6F6963] h-[52px]">
					<span>사용 가능한 포인트</span><span><?php echo $TPL_VAR["gmem"]["mempoints"]?></span>
				</div>
			</section>
					...
					<div role="radiogroup" aria-required="false" dir="ltr" class="grid gap-2" tabindex="0" style="outline: none;">
						...
						<div class="relative !w-[739px]">
							...
							<div id="card-scroll-container" class="flex gap-4 overflow-x-auto pb-2 scroll-smooth mx-8 w-[654px]">
								<div class="hidden w-[240px] h-[140px] !min-w-[240px] !max-w-[240px] p-6 rounded bg-black text-white text-sm flex flex-col justify-between">
						...
						<div role="radiogroup" aria-required="false" dir="ltr" class="grid grid-cols-2 gap-4 text-sm w-[739px]" tabindex="0" style="outline: none;"><label class="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 h-[46px] border rounded py-[12px] px-[24px] text-center text-[#322A24] cursor-pointer text-sm w-[357px] [h-46px] font-normal !border-[#E9E6E0]"><button type="button" role="radio" aria-checked="false" data-state="unchecked" value="card" class="aspect-square h-4 w-4 rounded-full border border-primary text-primary ring-offset-background focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 hidden" tabindex="-1" data-radix-collection-item=""></button>신용/체크카드</label><label class="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 h-[46px] border rounded py-[12px] px-[24px] text-center text-[#322A24] cursor-pointer text-sm w-[357px] [h-46px] font-normal !border-[#E9E6E0]"><button type="button" role="radio" aria-checked="false" data-state="unchecked" value="toss" class="aspect-square h-4 w-4 rounded-full border border-primary text-primary ring-offset-background focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 hidden" tabindex="-1" data-radix-collection-item=""></button>토스 퀵 계좌이체</label><label class="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 h-[46px] border rounded py-[12px] px-[24px] text-center text-[#322A24] cursor-pointer text-sm w-[357px] [h-46px] font-normal !border-[#E9E6E0]"><button type="button" role="radio" aria-checked="false" data-state="unchecked" value="naver" class="aspect-square h-4 w-4 rounded-full border border-primary text-primary ring-offset-background focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 hidden" tabindex="-1" data-radix-collection-item=""></button>네이버페이</label><label class="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 h-[46px] border rounded py-[12px] px-[24px] text-center text-[#322A24] cursor-pointer text-sm w-[357px] [h-46px] font-normal !border-[#E9E6E0]"><button type="button" role="radio" aria-checked="false" data-state="unchecked" value="bank" class="aspect-square h-4 w-4 rounded-full border border-primary text-primary ring-offset-background focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 hidden" tabindex="-1" data-radix-collection-item=""></button>무통장 입금</label></div>
					</div>
				</div>
			...
			<div class="sticky top-16">
				<aside class="space-y-6">
					...
					<div class="flex justify-between text-sm font-bold text-[#111111]">
						<span class="text-[#322A24]">적립 예정 포인트</span><span>+700</span>
					</div>
					...
					<div class="flex justify-end font-bold text-[#322A24] items-center">
						<span class="text-xs mr-3">합계</span><span class="text-lg">25,500원</span>
					</div>
