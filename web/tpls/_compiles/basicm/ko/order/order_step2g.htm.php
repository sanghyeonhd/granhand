<?php /* Template_ 2.2.7 2025/07/08 17:45:28 /home/grandhand/BUILDS/tpls/basicm/order/order_step2g.htm 000025358 */ 
...
<body>
<div id="root">
	<div class="min-h-screen bg-[#FDFBF5]">
		<div class="fixed top-0 left-0 right-0 h-[58px] flex px-6 items-center bg-[#FDFBF5]">
			<a href="#none" onclick="event.preventDefault(); history.back();" class="pr-6"><img src="/img/m/icon_ARROWLEFT_dark.png" /></a>
			<div class="text-lg font-bold">선물 결제하기</div>
		</div>
		<div class="px-6" style="padding-top:58px;">
			<div class="h-[54px] flex items-center justify-between">
				<div class="text-[#322A24] text-sm font-bold">선물 메시지</div>
				
			</div>
			<div class="pb-8"><img src="/img/m/1.png"></div>	
			...
			<div class="pb-4">
				<div class="flex items-center">
					<div class="flex pr-8">
						<div class="text-[#6F6963] text-xs font-medium">카카오톡으로</div>
					</div>
					<div class="flex pr-8">
						<div class="text-[#6F6963] text-xs font-medium">문자(SMS)로 선물</div>
					</div>
				</div>
			</div>
			<div class="px-4 py-4 mb-6" style="background-color:#322A2408">
				<div class="text-[#6F6963] text-sms">선물하기 클릭 후 카카오톡 친구 목록에서 받는 분을 선택해 주세요.</div>
				<div class="text-[#6F6963] text-sms">포인트 선물은 그랑핸드 회원만 받을 수 있어요.</div>
			</div>
			<div class="flex items-center text-[#322A24] text-sm font-bold">
				받는 분*
			</div>
			<div class="px-2" style="border:1px solid #C0BCB6;">
				<input type="text" placeholder="받는 분의 실명을 입력해 주세요." class="block bg-[#FDFBF4]  h-[44px] font-normal text-xs" />
			</div>
...
<?php }}?>
			...
			<div class="flex flex-col">
				<button style="border: 1px solid #6F6963;width:48%" class="text-[#322A24] text-sm font-normal py-3 mb-4">신용/체크카드</button>
			</div>
			...
			<div class="flex py-4 items-center mb-4" style="border-top:1px solid #E9E6E0;;border-bottom:1px dashed #E9E6E0">
				<div class="pr-4">
					<input type="checkbox" id="allCheck1" class="chk-hidden agree-item" >
...
<div class="fixed px-6 z-20 bg-[#FDFBF5] py-6" style="bottom:0;left:0;right:0;">
	<button type="button" id="f_buy" class="w-full block h-[46px] text-sm text-[#FFFFFF] font-bold disabled:opacity-15 bg-[#322A24]" disabled>결제하기</button>
</div>
